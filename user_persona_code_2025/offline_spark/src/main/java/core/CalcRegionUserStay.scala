...
object CalcRegionUserStay {
  def main(args: Array[String]): Unit = {
    ...
    //加载基站信令数据-HDFS
    val laccellSignFilePath = "I:\\data\\xdr.txt"//"hdfs://bigdata01:9000/xdr/nohup.txt"
    val laccellSignSchema = new StructType()
      ...
      .add("procedureStartTime",StringType,false)
    ...
    laccellSignDf.show(10, false)


    //加载行政区-基站关系数据-HDFS
    val regionCellFilePath = "I:\\data\\region_cell_new.txt"  //"hdfs://bigdata01:9000/data/regionCell"
